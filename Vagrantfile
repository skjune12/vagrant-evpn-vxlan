Vagrant.configure(2) do |config|
  ...
  config.vm.define :gobgp1 do |gobgp1|
    ...
    # outer network
    gobgp1.vm.network "private_network", ip: "10.10.0.10", netmask: "255.255.255.0"
    # basic setup
  ...
  config.vm.define :gobgp2 do |gobgp2|
    ...
    # outer network
    gobgp2.vm.network "private_network", ip: "10.10.0.20", netmask: "255.255.255.0"
    # basic setup
  ...
  #   # outer network
  #  gobgp3.vm.network "private_network", ip: "10.10.0.30", netmask: "255.255.255.0"
  #  # basic setup
